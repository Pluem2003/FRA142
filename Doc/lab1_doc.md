...
- สร้างโปรแกรมช่วยพี่เนคำนวณระยะทางการเดินใน 2 มิติ โดยจะรับค่าคำสั่งเป็น Array : [1, 2, 1, 3, 1, 2, 2, 1, 3, 2, 4, 1, 2, 3, 1, 4, 1, 2, 1, 3, 1, 2, 1, 1, 4]<br>
*** ให้เขียนโปรแกรมในส่วนการสร้างเงื่อนไข (Condition) คนละแบบกับข้อแรก เช่น ถ้าข้อแรกใช้ If-Else ข้อนี้ให้ใช้ Switch-Case เป็นต้น ***<br>
กำหนดให้
